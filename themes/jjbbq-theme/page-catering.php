...
$gf_id         = jjbbq_catering_gravity_form_id();
$gf_valid      = $gf_id > 0 && class_exists( 'GFAPI' ) && GFAPI::get_form( $gf_id );
$use_gravity   = $gf_valid && function_exists( 'gravity_form' );
?>
...
<main id="main-content" class="site-main">
    ...
    <section class="catering-content">
        <div class="container">
            ...
            <!-- Inquiry Form: Gravity Forms or built-in -->
            <?php if ( $use_gravity ) : ?>
                <div class="catering-form jjbbq-gf-catering">
                    <h2><?php esc_html_e( 'Get in Touch', 'jjbbq' ); ?></h2>
                    <?php
                    /**
                     * Legacy theme + style_settings false = no Orbital inline --gf-* block; simpler markup.
                     * Form CSS class `jjbbq-catering-form` optional (extra hooks in SCSS).
                     */
                    gravity_form( $gf_id, false, false, false, null, false, 0, true, 'legacy', false );
                    ?>
                </div>
            <?php else : ?>
